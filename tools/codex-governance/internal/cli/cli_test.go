...
func TestRunImplementationAdoptRequiresAuditEvidence(t *testing.T) {
	args := []string{"implementation", "adopt", "--run", "run.json", "--bundle", "bundle.json", "--candidate-worktree", ".", "--review-evidence", "review.json", "--check-evidence", "checks.json", "--registry", "/tmp/registry", "--reason", "reason", "--issued-at", "2026-07-20T00:00:00Z", "--expires-at", "2026-07-20T01:00:00Z"}
