...
func adoptionID(r AdoptionRecord) string {
	return "adoption-" + strings.TrimPrefix(signature.Digest([]byte(strings.Join([]string{r.RepositoryID, r.WorkItemKey, r.PredecessorRunID, r.OriginalBaseSHA, r.PredecessorCommitSHA, r.CandidateCommitSHA}, "\x00"))), "sha256:")
}
